...
xmlns:doc="http://nwalsh.com/xsl/documentation/1.0" xmlns:db="http://docbook.org/ns/docbook" xmlns:ng="http://docbook.org/docbook-ng" xmlns="http://www.w3.org/1999/xhtml" version="1.0" exclude-result-prefixes="doc db ng d">
